        ...
        if (at === 6 && !capsOnly) {
          ...
          if (sq === home) {
            if (us === WHITE) {
              ...
              if ((pos.castling & 2) && !b[3] && !b[2] && b[0] === 4 && !attacked(pos, 4, them) && !attacked(pos, 3, them) && !attacked(pos, 2, them))
              ...
              if ((pos.castling & 8) && !b[115] && !b[114] && b[112] === -4 && !attacked(pos, 116, them) && !attacked(pos, 115, them) && !attacked(pos, 114, them))
