...
def cmd_next():
    ...
    print("Do (NO verification - skip tests and bench entirely):")
    print("  1. Implement the task as a minimal diff.")
    print("  2. Commit THAT change alone (stage only its files, never push):")
    print('     git -c user.name="chess-trainer" -c user.email="chess-trainer@local" commit -m "<type>: <what>"')
    print("  3. Record it: python selfloop.py done \"<run-log entry>\"")
